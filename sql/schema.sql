...
CREATE TABLE IF NOT EXISTS instances (
    ...
    db_username           VARCHAR(100) NOT NULL DEFAULT 'root',
...
INSERT INTO instances
    (instance_name, database_type, instance_ip, port_number, db_username, db_password,
     status, last_down_time, last_backup_date, last_backup_location,
     last_backup_duration, last_backup_file_size, last_backup_remark)
VALUES
    ('ICARD', 'MySQL/Oracle', '10.180.18.2', 3600, 'root', '', 'Connected', '2025-05-25 10:30:00',
     '2026-05-25 10:30:00', 'd://databasebackup/25052025.dmp', '2 min 3 sec', '10MB',
     'Backup completed successfully.'),

    ('ICARD-DR', 'MySQL/Oracle', '10.180.18.3', 3600, 'root', '', 'Connected', '2025-05-20 09:15:00',
     '2026-05-24 22:00:00', 'd://databasebackup/24052025.dmp', '1 min 50 sec', '9.8MB',
     'Backup completed successfully.'),

    ('CRM-DB', 'Oracle', '10.180.20.5', 1521, 'root', '', 'Disconnected', '2026-06-01 03:00:00',
